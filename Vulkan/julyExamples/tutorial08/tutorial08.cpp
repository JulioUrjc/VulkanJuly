...
const std::string getAssetPath()
{
  ...
  return "";
#elif defined(VK_EXAMPLE_DATA_DIR)const std::string getAssetPath()
  {
#if defined(VK_USE_PLATFORM_ANDROID_KHR)
    return "";
  ...
  const std::string TEXTURE_PATH = getAssetPath() + "texturesJuly/chalet.jpg";
  return VK_EXAMPLE_DATA_DIR;
#else
  return "./../data/";
#endif
...
private:
  ...
  void createGraphicsPipeline() {
    auto vertShaderCode = readFile(getAssetPath() + "shadersJuly/tutorial08/vert.spv");
    auto fragShaderCode = readFile(getAssetPath() + "shadersJuly/tutorial08/frag.spv");
